...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Entities.Stage", b =>
                {
            ...
            modelBuilder.Entity("Domains.Entities.StageSubject", b =>
                {
                    ...
                    b.ToTable("StageSubjects", (string)null);
                });

            modelBuilder.Entity("Domains.Entities.StudentSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Entities.StudentsStudyInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentsStudyInfos", (string)null);
                });

            modelBuilder.Entity("Domains.Entities.SubStage", b =>
                {
                    b.Property<int>("SubStageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubStages", (string)null);
                });

            modelBuilder.Entity("Domains.Entities.Subject", b =>
                {
                    b.Property<int>("SubjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Entities.Teacher", b =>
                {
            ...
            modelBuilder.Entity("Domains.Entities.TeacherSubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Entities.Term", b =>
                {
                    b.Property<int>("TermId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domains.Entities.TimeTableGroup", b =>
                {
                    ...
                    b.ToTable("TimeTableGroups", (string)null);
                });
            ...
            modelBuilder.Entity("Domains.Entities.TimeTableGroupDetail", b =>
                {
                    ...
                    b.ToTable("TimeTableGroupsDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Domains.Entities.TrackUsersProcess", b =>
                {
                    ...
                    b.ToTable("TrackUsersProcesses", (string)null);
                });
            ...
            modelBuilder.Entity("Domains.Entities.StageSubject", b =>
                {
                    b.HasOne("Domains.Entities.SubStage", "SubStage")
                        .WithMany("StageSubjects")
                        .HasForeignKey("SubStageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domains.Entities.Subject", "Subject")
                        .WithMany("StageSubjects")
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domains.Entities.Term", "Term")
                        .WithMany("StageSubjects")
            ...
            modelBuilder.Entity("Domains.Entities.StudentsStudyInfo", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.SubStage", null)
            ...
            modelBuilder.Entity("Domains.Entities.SubStage", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.Stage", "Stage")
                        .WithMany("SubStages")
            ...
            modelBuilder.Entity("Domains.Entities.TeacherSubject", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.Subject", null)
                        .WithMany("TeacherSubjects")
                        .HasForeignKey("SubjectId");

                    b.HasOne("Domains.Entities.Teacher", "Teacher")
                        .WithMany("TeacherSubjects")
            ...
            modelBuilder.Entity("Domains.Entities.TimeTable", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.Teacher", null)
                        .WithMany("TimeTables")
